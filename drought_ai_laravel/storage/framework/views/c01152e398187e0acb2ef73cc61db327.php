<?php $__env->startSection('title','Analyse Photo & Vidéo'); ?>
  ...
  <div>
    <div class="card">
      ...
      <div class="cb">
        ...
        <form method="POST" action="<?php echo e(route('analysis.post')); ?>" enctype="multipart/form-data" id="aform">
          <?php echo csrf_field(); ?>
          ...
          <div class="fg">
            ...
            <div class="tpicker">
              <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <label class="tp <?php echo e($key==='full'?'picked':''); ?>" onclick="pickType(this)">
                <input type="radio" name="type" value="<?php echo e($key); ?>" <?php echo e($key==='full'?'checked':''); ?>>
                <span class="tp-i"><?php echo e($t['icon']); ?></span>
                <span class="tp-l"><?php echo e($t['label']); ?></span>
              </label>
  ...
  <div style="display:flex;flex-direction:column;gap:1.2rem">
    <div class="card">
      ...
      <div class="cb">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$ico,$ttl,$desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div style="display:flex;gap:10px;margin-bottom:.9rem">
          <span style="font-size:1.35rem;flex-shrink:0;line-height:1;margin-top:.1rem"><?php echo e($ico); ?></span>
          <div>
            <div style="font-weight:700;font-size:.87rem;margin-bottom:.15rem"><?php echo e($ttl); ?></div>
            <div style="font-size:.77rem;color:var(--mu);line-height:1.5"><?php echo e($desc); ?></div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    ...
    <div class="card">
      ...
      <div class="cb">
        ...
        <div style="display:flex;gap:9px;margin-bottom:.85rem">
          <div style="width:24px;height:24px;border-radius:50%;background:var(--g);color:#fff;font-weight:800;font-size:.78rem;display:flex;align-items:center;justify-content:center;flex-shrink:0"><?php echo e($n); ?></div>
          <div>
            <div style="font-weight:700;font-size:.85rem;margin-bottom:.12rem"><?php echo e($t); ?></div>
            <div style="font-size:.76rem;color:var(--mu);line-height:1.5"><?php echo e($d); ?></div>
          </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mohame Lemine\Desktop\drought_yolo\drought_ai_laravel\resources\views/analysis/index.blade.php ENDPATH**/ ?>
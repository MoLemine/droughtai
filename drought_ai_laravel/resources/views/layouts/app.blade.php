...
<title>@yield('title','DroughtAI') — Prédiction Sécheresse</title>
...
<nav>
  ...
  <a href="{{ route('analysis') }}"   class="nav-a {{ request()->routeIs('analysis*') ?'on':'' }}"><span class="nicon">📷</span><span>Analyse Photo/Vidéo</span></a>
  <div class="ml-a">
    <div class="api-status {{ isset($online)&&$online ? 'online':'offline' }}">
      <span class="dot"></span>
      API {{ isset($online)&&$online ? 'En ligne':'Hors ligne' }}
    </div>
  </div>
</nav>
